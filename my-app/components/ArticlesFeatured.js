...
export default class ArticlesFeatured extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const featuredCards = this.state.articles.map(({ header, image, link, catColor }, i) => (
    ...
    return (
      <div className="row">
        ...
        >
          <CardDeck className="featuredCatDeck">{featuredCards}</CardDeck>
        </CSSTransitionGroup>
      </div>
    );
  }
